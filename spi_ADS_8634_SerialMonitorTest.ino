...
byte channelSelection[4] = {B10000000, B00100000, B00001000, B00000010};//Ch0 x Ch1 x Ch2 x Ch3 x
...
void setup() {
  ...
  //send chip settings writeSPI(reg, setting)  reg bits:  R6 R5 R4 R3 R2 R1 R0 R/W  Write = 0
    ...
    //check how long digitalWrite takes - long enough for td(CS-DO) = 40 ns?
  ...
  writeSPI(B00001100, B00001100);  //register is 7-bit address, MSB is R/W: Write = 0
    ...
    //auto scan channels - what should default be...?  always scanning all four is easiest...?
